...
function setHighScoreTable(table) {
    for (var i = 0; i < 10; i++) {
        ...
        var cookie_val = table[i].name + "~" + table[i].score;

        var now = new Date();
        now.setTime(now.getTime() + 365 * 24 * 60 * 60 * 1000);

        setCookie(cookie_name, cookie_val, now, null, null);
    }
}
...
//
// This function hides the high score table  
//
